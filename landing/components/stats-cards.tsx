...
import { Activity, Clock, Heart, TrendingUp, MapPin } from "lucide-react"
import { ProcessedStats, formatDuration } from "@/lib/data-processor"
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            Max: {stats.maxHR} · Min: {stats.minHR}
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            {stats.sessionsWithGPS} sesiones con GPS
          </p>
        </CardContent>
      </Card>
    </div>
